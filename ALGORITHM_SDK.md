...
Rt 106 has been designed to be as easy as possible to add your own algorithms.  The procedure for adding an algorithm would be expected to take 2-3 hours, depending on the complexity of your algorithm.
...
```
There are a couple of options for organizing your Docker Compose file(s).  Your application can have a single docker-compose.yml file.  A benefit is simple commands for managing your application.  For example, you will be able to launch your application by simply typing:
```
docker-compose up
```
